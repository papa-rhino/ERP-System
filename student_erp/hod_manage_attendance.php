...
?>
  ...
  <div class="row pt-2 ">
    ...
    <div class="list-group">
              ...
              <a href="hod_manage_attendance.php" class="list-group-item list-group-item-action active">Manage Attendance</a>
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        <form action="<?php $_SERVER["PHP_SELF"] ?>" method="post">
          ...
          <div class="form-group">
            <label>Status</label>
            <input name="status" type="text" class="form-control" placeholder="present or absent">
          </div>
